...
class Generator(object):
      src_includes = "// This code is autogenerated by hascal, don't change it"
      src_pre_main = ""
            ...
            if self.test(tree):
                  ...
                  if use :
                        ...
                        if getenv('HASCAL_ROOT') != None :
                              hascal_runtime_path = str(getenv('HASCAL_ROOT') + "\\rt" + "\\core.d")
                              hascal_runtime = ""
      ...
      def walk(self, node):
            ...
            if node[0] == 'call':
                  if self.exists(node[1]):
                        if node[1] == "print":
                              return "std::cout << %s" % ('<< '.join(self.walk(arg) for arg in node[2]))
                        else :
